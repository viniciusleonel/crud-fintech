...
<div class="container">
	<h1 class="mt-2">Edição de Receita</h1>
	...
	<form action="receita" method="post">
		...
		<div class="form-group mt-1 pt-1">
			...
			<input type="text" name="data" id="id-data" class="form-control" value='<fmt:formatDate value="${receita.data.time }" pattern="dd/MM/yyyy"/>'>
		</div>
		<div class="form-group mt-1 pt-1">
			<label for="id-categoria">Categoria</label>
			<input type="text" name="categoria" id="id-categoria" class="form-control" value="${receita.categoria}">
		</div>
		<div class="form-group mt-1 pt-1">
		...
		<a href="receita?acao=listar" class="btn btn-danger mt-2">Cancelar</a>
	</form>
</div>
